...
public class Inicijalizator extends Cvor {
	...
	private void provjeri1() {
		...
		izraz.provjeri();
		if (SemantickiAnalizator.nizZnakova) {
			brojElemenata = SemantickiAnalizator.duljinaZnakova + 1;
		...
		SemantickiAnalizator.duljinaZnakova = 0;
		SemantickiAnalizator.nizZnakova = false;
	}
